...
export class ScaleBarComponent implements OnInit, OnDestroy, OnChanges {
  ...
  private addGlobalListeners(): void {
    document.addEventListener('pointermove', this.onDragMove as EventListener);
    document.addEventListener('pointerup', this.onDragEnd as EventListener);
  }
  ...
  private removeGlobalListeners(): void {
    document.removeEventListener('pointermove', this.onDragMove as EventListener);
    document.removeEventListener('pointerup', this.onDragEnd as EventListener);
  }
}
